...
<body>
	...
	<form method="POST" action="RegisteredServlet" class="box1">
		<dl>
			...
			<dt>タスク期限</dt>
			<dd>
				<input name="datekigen" type="date"> <input name="timekigen"
					type="time">
			</dd>
			<dt>アラートメール送信</dt>
			<dd>
			...
			<dt>メールの送信日時</dt>
			<dd>
				<input name="datemailtime" type="date"> <input
					name="timemailtime" type="time">
			</dd>
			<dt>繰り返し設定</dt>
			<dd>
			...
			<dt>繰り返し間隔</dt>
			<dd>
				<input name="month" type="number" value="0" min="0" max="12">か月
				<input name="day" type="number" value="0" min="0" max="30">日
				<input name="hour" type="number" value="0" min="0" max="23">時
				<input name="min" type="number" value="0" min="0" max="59">分
			</dd>
		</dl>
